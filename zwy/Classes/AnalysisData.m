...
+ (NSMutableArray *)imRevice:(NSDictionary *)dic{
    ...
    for (int i=0;i<arr.count; i++) {
        ...
        obj.receiveravatar=[[[arr objectAtIndex:i] objectForKey:@"senderimgpath"] objectForKey:@"text"];
        ...
        obj.senderavatar=[[[arr objectAtIndex:i] objectForKey:@"receiverimgpath"] objectForKey:@"text"];
